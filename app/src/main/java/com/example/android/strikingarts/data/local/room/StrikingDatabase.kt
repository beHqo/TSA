...
import com.example.android.strikingarts.data.local.room.typeconverters.WorkoutIdListTypeConverter

@Database(
    entities = [Technique::class, Combo::class, Workout::class, ComboTechniqueCrossRef::class, WorkoutComboCrossRef::class, TrainingDate::class],
    version = 1,
    exportSchema = true
)
@TypeConverters(value = [DataAudioAttributesTypeConverter::class, WorkoutIdListTypeConverter::class])

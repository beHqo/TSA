package com.thestrikingarts.ui.components.listitem
...
import com.thestrikingarts.ui.components.SelectableButton
import com.thestrikingarts.ui.theme.designsystemmanager.PaddingManager
import com.thestrikingarts.ui.theme.designsystemmanager.SizeManager.ListItemMinHeight
...
fun BaseItemWithMultipleLinesSelectionMode(
    ...
    modifier = modifier
        .heightIn(min = ListItemMinHeight)
        .combinedClickable(
            onClick = { onSelectionChange(itemId, !selected) },
